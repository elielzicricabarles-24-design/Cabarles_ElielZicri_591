...
class _CalculatorScreenState extends State<CalculatorScreen> {
  ...
  void initState() {
    super.initState();
    _display = '0'; // Shows current number or result
    _firstOperand = ''; // Stores first number before operator
    _operator = ''; // Stores selected operation
    _shouldResetDisplay = false; // Flag for display reset
    _expression = ''; // Shows the full expression
  }
      ...
      try {
        switch (function) {
          case 'sin':
            ...
            _expression = "sin($num°) = $result";
          case 'cos':
            result = cos(num * pi / 180);
            _expression = "cos($num°) = $result";
          case 'tan':
            if (num == 90 || num == 270) {
              _display = "Error";
        ...
        switch (function) {
          case 'sin':
            _display = "Error";
            _expression = "sin($num°) is undefined";
          case 'cos':
            _display = "Error";
            _expression = "cos($num°) is undefined";
          case 'tan':
            _display = "Error";
            _expression = "tan($num°) is undefined";
          case '√':
